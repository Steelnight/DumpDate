...
SAMPLE_SUBSCRIPTIONS = [
    {"id": 1, "chat_id": 101, "address_id": 1, "notification_time": "evening", "last_notified": None},
    {"id": 2, "chat_id": 102, "address_id": 2, "notification_time": "morning", "last_notified": "2023-10-26"},
]

SAMPLE_EVENTS = [
    {"original_address": "Test Straße 1", "date": "2023-10-27", "waste_type": "Rest-Tonne"}, # Tomorrow
    {"original_address": "Musterweg 2", "date": "2023-10-26", "waste_type": "Bio-Tonne"},   # Today
]
...
def test_get_due_notifications():
    ...
    mock_persistence_instance.get_all_active_subscriptions.return_value = SAMPLE_SUBSCRIPTIONS
    ...
    def get_address_by_id_side_effect(address_id):
        if address_id == 1: return "Test Straße 1"
        if address_id == 2: return "Musterweg 2"
        return None
    mock_persistence_instance.get_address_by_id.side_effect = get_address_by_id_side_effect
    ...
    with patch('schedule_parser.services.notification_service.datetime') as mock_datetime:
