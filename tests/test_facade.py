...
def mock_ics_parser():
     with patch('schedule_parser.facade.parse_ics') as mock_parse:
        mock_parse.return_value = [
            WasteEvent(uid="1", date="2026-01-01", location="Test", waste_type="Restmüll", contact_name="", contact_phone="")
        ]
        yield mock_parse
...
def test_get_schedule_for_address_integration(tmp_path, mock_address_finder, mock_ical_downloader, mock_ics_parser, mock_temp_file):
